...
namespace Hospital.Application.Response
{
    public class Response<T> : BaseResponse
    {
        ...
        //friendlymessqge yaz
        public Response<T> Ok(T data, string friendlyMessage = "Successfully")
        {
            //generic doğru
            return new Response<T>() { Data = data, Code = HttpStatusCode.OK, Message = "Success", FriendlyMessage = friendlyMessage};
        }

        public Response<T> Created(string friendlyMessage = "Successfully")
        {
            return new Response<T>() { Code = HttpStatusCode.Created, Message = "Created", FriendlyMessage = friendlyMessage};
        }
